...
class AgentDetailsWidget extends StatefulWidget {
  const AgentDetailsWidget({super.key});

  @override
  State<AgentDetailsWidget> createState() => _AgentDetailsWidgetState();
}

class _AgentDetailsWidgetState extends State<AgentDetailsWidget>
    with TickerProviderStateMixin {
  late AgentDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgentDetailsModel());
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(24.0, 4.0, 0.0, 0.0),
                    child: Text(
                      'if not sure, ask property owner for ID',
                      style: FlutterFlowTheme.of(context).labelMedium.override(
                            fontFamily:
                                FlutterFlowTheme.of(context).labelMediumFamily,
                            letterSpacing: 0.0,
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                if (_model.iDNumTextController.text ==
                                    '2015/213103/07') {
                                  await AgentRecord.collection
                                      .doc()
                                      .set(createAgentRecordData(
                                        userId: currentUserReference,
                                        agentName: currentUserDisplayName,
                                        agentSurname: valueOrDefault(
                                            currentUserDocument?.userSurname,
                                            ''),
                                        companyId:
                                            _model.iDNumTextController.text,
                                        agentEmail: currentUserEmail,
                                        agentTelNumber: currentPhoneNumber,
                                        agentIdString: random_data.randomString(
                                          12,
                                          12,
                                          true,
                                          true,
