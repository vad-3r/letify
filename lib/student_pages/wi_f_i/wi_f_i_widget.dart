...
import 'wi_f_i_model.dart';
export 'wi_f_i_model.dart';

class WiFIWidget extends StatefulWidget {
  const WiFIWidget({super.key});

  static String routeName = 'WiFI';
  static String routePath = '/wiFI';

  @override
  State<WiFIWidget> createState() => _WiFIWidgetState();
}

class _WiFIWidgetState extends State<WiFIWidget> with TickerProviderStateMixin {
