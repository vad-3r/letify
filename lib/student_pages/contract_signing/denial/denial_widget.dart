...
import 'denial_model.dart';
export 'denial_model.dart';

class DenialWidget extends StatefulWidget {
  const DenialWidget({
    super.key,
  ...
  @override
  State<DenialWidget> createState() => _DenialWidgetState();
}

class _DenialWidgetState extends State<DenialWidget>
    with TickerProviderStateMixin {
  late DenialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DenialModel());
                          ...
                          Padding(
                            ...
                            child: Text(
                              valueOrDefault<String>(
                                columnTenantInfoRecord?.denialReason,
                                'Reason Not Provided',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  ...
                                  return WebViewAware(
                                    child: Padding(
                                      ...
                                      child: StudentContractStartWidget(
                                        ...
                                        tenantInfoID: widget.tenantContract!,
                                      ),
                                    ),
                                  );
                                },
