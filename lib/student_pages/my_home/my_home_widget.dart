...
class _MyHomeWidgetState extends State<MyHomeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyHomeModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PropertyRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PropertyRecord> myHomePropertyRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final myHomePropertyRecord = myHomePropertyRecordList.isNotEmpty
            ? myHomePropertyRecordList.first
            : null;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () async {
                await launchURL(myHomePropertyRecord!.houseGroupLink);
              },
                          ...
                          RichText(
                            ...
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text:
                                      'Below is the property you are occupying',
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    text:
                                        'Click on the House icon at the bottom to access the WhatsApp group chat',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                          fontFamily:
