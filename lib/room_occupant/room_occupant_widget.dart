...
import '/landlord_pages/property_listing/tenants/remove_prelink/remove_prelink_widget.dart';
...
import 'room_occupant_model.dart';
export 'room_occupant_model.dart';

class RoomOccupantWidget extends StatefulWidget {
  const RoomOccupantWidget({
    super.key,
    required this.propertyID,
    required this.propertyName,
    required this.roomID,
    required this.roomName,
    required this.tenantInRoom,
  ...
  final DocumentReference? tenantInRoom;
  ...
  static String routeName = 'Room_Occupant';
  static String routePath = '/roomOccupant';

  @override
  State<RoomOccupantWidget> createState() => _RoomOccupantWidgetState();
}

class _RoomOccupantWidgetState extends State<RoomOccupantWidget> {
  late RoomOccupantModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RoomOccupantModel());
              ...
              child: Padding(
                ...
                child: StreamBuilder<List<RoomRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<RoomRecord> scrollingColumnRoomRecordList =
                        snapshot.data!;
                    // Return an empty Container when the item does not exist.
                    if (snapshot.data!.isEmpty) {
                      return Container();
                    }
                    final scrollingColumnRoomRecord =
                        scrollingColumnRoomRecordList.isNotEmpty
                            ? scrollingColumnRoomRecordList.first
                            : null;
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          if (scrollingColumnRoomRecord?.tenantInRoom != null)
                            StreamBuilder<List<UserRecord>>(
                              stream: queryUserRecord(
                                queryBuilder: (userRecord) => userRecord.where(
                                  'uid',
                                  isEqualTo: widget.tenantInRoom?.id,
                                ),
                                singleRecord: true,
                              ),
                              builder: (context, snapshot) {
                                ...
                                List<UserRecord> occupantInfoUserRecordList =
                                    snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                }
                                final occupantInfoUserRecord =
                                    occupantInfoUserRecordList.isNotEmpty
                                        ? occupantInfoUserRecordList.first
                                        : null;
                          ...
                          Row(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              if ((widget.roomStatus == 'Vacant') &&
                                  (scrollingColumnRoomRecord?.tenantInRoom ==
                                      null))
                                Text(
                                  'Link',
                                  style: FlutterFlowTheme.of(context)
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if ((scrollingColumnRoomRecord?.roomStatus ==
                                          'Occupied') &&
                                      (scrollingColumnRoomRecord?.tenantName ==
                                          'Pre-Linked Tenant'))
                                    Align(
                                  ...
                                  if ((widget.roomStatus == 'Occupied') &&
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        if ((currentUserDocument?.permissions
                                                        .toList() ??
                                                    [])
                                                .contains(functions.aString(
                                                    'De-Link Tenants')) ==
                                            true) {
                                          if (scrollingColumnRoomRecord
                                                  ?.isGenerated ==
                                              true) {
                                            await showDialog(
                                              context: context,
                                                  ...
                                                  child: GestureDetector(
                                                    ...
                                                    child: Padding(
                                                      padding: MediaQuery
                                                          .viewInsetsOf(
                                                              context),
                                                      child: DeLinkTenantWidget(
                                                        propertyID:
                                                            widget.propertyID!,
                                                        roomID: widget.roomID!,
                                                        studentInRoom: widget
                                                            .tenantInRoom!,
                                                      ),
                                                    ),
                                                  ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Flexible(
                                  child: Text(
                                    'Note that contracts are only available once tenant is linked to the room',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily:
