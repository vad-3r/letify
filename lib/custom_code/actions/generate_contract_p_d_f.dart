...
Future<void> generateContractPDF(
  ...
  //Water Mark
  final response55 = await http.get(Uri.parse(waterMark));
  final waterMarkImage = pw.MemoryImage(response55.bodyBytes);

  //Principal Stamp
  final response56 = await http.get(Uri.parse(principalStamp));
  final stampImage = pw.MemoryImage(response56.bodyBytes);
  ...
  pdf.addPage(pw.MultiPage(
    ...
    return [
        ...
        child: pw.Column(
          children: [
            ...
            pw.Text('AND\n $lesseeName \n (HENCEFORWARD THE LESSEE)',
                ...
                style:
                    pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold)),
            pw.Text('Property: [PROPERTY NAME], Unit: [UNIT NAME]',
                textAlign: pw.TextAlign.center,
                style:
                    pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold)),
      ...
      pw.Text('Email: ${lesseeEmail ?? 'lessee email'}',
          style: pw.TextStyle(fontSize: 10)),
      pw.Text('Student Number: ', style: pw.TextStyle(fontSize: 10)),
      pw.SizedBox(height: 10),
      //pw.Text(
      //    'Address: $lessorStreetAddress, $lessorSuburb, $lessorCity, $lessorPostalCode'),
      ...
      if (roomType.toUpperCase() == 'SHARING')
        pw.Center(
          child: pw.Column(children: [
            ...
            pw.SizedBox(height: 10),
            pw.Text(
                'Tenants that stay in Sharing Rooms/ Sharing Flats pay sharing prices and paid their full admin fee will be eligble to recieve their R2500 non-refundable admin fee back (Only if full amount was paid) if the following criteria are met during the course of the year:',
                style: pw.TextStyle(fontSize: 10)),
            pw.SizedBox(height: 10),
            pw.Bullet(
                text:
            ...
            pw.Bullet(
                ...
                style: pw.TextStyle(fontSize: 10)),
            pw.Text(
                'NB! People staying in sharing room are responsible to buy their own electricity for the room, provided there is a prepaid meter in the room.'),
            pw.SizedBox(height: 20),
          ]),
        ),
      //
      ...
      if (roomType.toUpperCase() == 'SINGLE')
        pw.Column(children: [
          ...
          pw.SizedBox(height: 10),
          pw.Text(
              'The tenant will be eligible to receive their refund back (only if full amount was paid) if the following criteria are met during the year:',
              style: pw.TextStyle(fontSize: 10)),
          pw.SizedBox(height: 10),
          pw.Bullet(
              text:
      ...
      if (roomType.toUpperCase() == 'BACHELOR')
        pw.Center(
          child: pw.Column(children: [
            ...
            pw.SizedBox(height: 10),
            pw.Text(
                'NB! People staying in bachelor rooms are responsible to buy their own electricity for the room they occupy, provided that the room has a prepaid meter.',
                style: pw.TextStyle(fontSize: 10)),
            pw.SizedBox(height: 20),
          ]),
        ),
        ...
        pw.Center(
          child: pw.Column(children: [
            ...
            pw.Text('Admin Fee: R$adminFee (NON-REFUNDABLE)',
                style: pw.TextStyle(fontSize: 10)),
            pw.Text('Deposit: R$deposit', style: pw.TextStyle(fontSize: 10)),
            pw.Text('Key Deposit: R$keyDeposit (NON-REFUNDABLE)',
                style: pw.TextStyle(fontSize: 10)),
            pw.SizedBox(height: 20),
          ]),
        ),
      ...
      pw.Text('Branch Name: Langenhoven park',
          style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)),
      pw.Text('REF: HOUSE/STUDENT NUMBER',
          style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)),
      pw.SizedBox(height: 20),
      ...
      pw.Padding(
        ...
        child: pw
          ...
          pw.Text(
              '1. The lessee occupies the following part of the property: Property: [House], Unit: [Room Name]',
              style: pw.TextStyle(fontSize: 10)),
          pw.SizedBox(height: 10),
          pw.Text(
              '2. This rental contract will start on ' +
                  ...
                  '.All items must be removed from the rooms including the fridge 7 days after classes and exams end at the end of 2025. We have the right to remove everything from the end of your contract if you have not renewed your contract in writing.',
              style:
          ...
          pw.SizedBox(height: 10),
          pw.Text(
              '5. $lessorName reserves the right to move a cash student to another property if needed.',
              style: pw.TextStyle(fontSize: 10)),
          pw.SizedBox(height: 10),
          pw.Text(
          ...
          pw.Text('9.1 Geyser Rules: $gesyerRules',
              style:
                  pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)),
          pw.SizedBox(height: 10),
          pw.Text(
          ...
          pw.SizedBox(height: 20),
          pw.Text('Lessee Signature: ___________________________'),
          ...
          pw.Text(
              '25. If the rent, as noted, or any other amount or amounts payable to the lessor by the lessee is not paid ' +
                  ...
                  'regarding the breaking of any stipulations of this contract by the lessee will not be taken into ' +
          ...
          pw.Text(
              ...
              style: pw.TextStyle(fontSize: 10)),
          pw.SizedBox(height: 10),
          pw.Text('36. The following is agreed upon regarding guests:',
              style: pw.TextStyle(fontSize: 10)),
          pw.SizedBox(height: 10),
          pw.Bullet(
      ...
      pw.Text(
          'We have the right to charge a penalty fee between R200 - R1000 per person if the rules are not obeyed.' +
              'The amount will be determined pending offence.',
          style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)),
      pw.SizedBox(height: 10),
      pw.Text('In severe cases 48-hour eviction may be enforced.',
          style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)),
      pw.SizedBox(height: 20),
      //tenant signature
      pw.Text('Lessee Signature: ___________________________',
      ...
      pw.Bullet(
          ...
          style: pw.TextStyle(fontSize: 10)),
      pw.Bullet(
          text: 'Cook in your room, please use the kitchen.',
          style: pw.TextStyle(fontSize: 10)),
      pw.Bullet(
      ...
      pw.Bullet(
          ...
          style: pw.TextStyle(fontSize: 10)),
      pw.Bullet(
          text: 'Stoves, hobs, microwave and kettles: These are very high energy (electricity) consuming ' +
      ...
      pw.Bullet(
          text:
              'Abuse washing machine. Remove any change, tissues, or any other items that can damage the machine before your wash. Clothing only to be thrown in ' +
    ...
    return pw.Container(
      ...
      margin: const pw.EdgeInsets.only(top: 1), // Adjust to fine-tune position
      child: pw.Column(
        mainAxisAlignment: pw.MainAxisAlignment.end,
        crossAxisAlignment: pw.CrossAxisAlignment.end,
        children: [
          pw.Image(image as pw.ImageProvider,
              width: 30), // Always show the main image
          if (signature1 != null) ...[
            pw.SizedBox(height: 4),
            pw.Image(signature1,
                height: 70, width: 70), // Direct usage, no cast needed
          ],
          if (signature2 != null) ...[
            pw.SizedBox(height: 4),
            pw.Image(signature2,
