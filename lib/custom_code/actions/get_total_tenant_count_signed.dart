...
Future<int> getTotalTenantCountSigned(DocumentReference landlordRef) async {
  ...
  for (var contractDoc in querySnapshot.docs) {
    if (contractDoc.data() != null &&
      ...
      List<dynamic> tenantsLinked = contractData.containsKey('is_signed_list')
          ? contractData['is_signed_list']
          : [];
