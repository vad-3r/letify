...
import 'l9_portfolio_details_linked_model.dart';
export 'l9_portfolio_details_linked_model.dart';

class L9PortfolioDetailsLinkedWidget extends StatefulWidget {
  const L9PortfolioDetailsLinkedWidget({
    super.key,
  ...
  static String routeName = 'L9_Portfolio_Details_Linked';
  static String routePath = '/l9PortfolioDetailsLinked';

  @override
  State<L9PortfolioDetailsLinkedWidget> createState() =>
      _L9PortfolioDetailsLinkedWidgetState();
}

class _L9PortfolioDetailsLinkedWidgetState
    extends State<L9PortfolioDetailsLinkedWidget> {
  late L9PortfolioDetailsLinkedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => L9PortfolioDetailsLinkedModel());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(LinkedPortfoliosWidget.routeName);
            },
          ),
          title: Text(
                              ...
                              children: [
                                ...
                                if (scrollingColumnPortfolioRecord
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed(
                                        LinkedPropertiesWidget.routeName,
                                        queryParameters: {
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    await actions.countdownFromFour();

                                    context.pushNamed(
                                      UnitAnalyticsLinkedWidget.routeName,
                                      queryParameters: {
                                        ...
                                        'allSingleVacantRooms': serializeParam(
                                        ...
                                        'allVacantSharingRooms': serializeParam(
