...
import 'landlord_dashboard_copy2_model.dart';
export 'landlord_dashboard_copy2_model.dart';

class LandlordDashboardCopy2Widget extends StatefulWidget {
  const LandlordDashboardCopy2Widget({super.key});

  static String routeName = 'Landlord_DashboardCopy2';
  static String routePath = '/landlordDashboardCopy2';

  @override
  State<LandlordDashboardCopy2Widget> createState() =>
      _LandlordDashboardCopy2WidgetState();
}

class _LandlordDashboardCopy2WidgetState
    extends State<LandlordDashboardCopy2Widget> with TickerProviderStateMixin {
  late LandlordDashboardCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LandlordDashboardCopy2Model());
                                        ...
                                        items: [
                                          ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.asset(
                                              'assets/images/advertising-word-cloud-business-concept-56936998.webp',
                                              width: 300.0,
                                              height: 200.0,
                                              fit: BoxFit.cover,
                                            ),
