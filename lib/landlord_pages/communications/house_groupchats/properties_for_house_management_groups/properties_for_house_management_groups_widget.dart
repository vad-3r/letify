...
import 'properties_for_house_management_groups_model.dart';
export 'properties_for_house_management_groups_model.dart';

class PropertiesForHouseManagementGroupsWidget extends StatefulWidget {
  const PropertiesForHouseManagementGroupsWidget({super.key});

  static String routeName = 'Properties_For_House_Management_Groups';
  static String routePath = '/propertiesForHouseManagementGroups';

  @override
  State<PropertiesForHouseManagementGroupsWidget> createState() =>
      _PropertiesForHouseManagementGroupsWidgetState();
}

class _PropertiesForHouseManagementGroupsWidgetState
    extends State<PropertiesForHouseManagementGroupsWidget> {
  late PropertiesForHouseManagementGroupsModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => PropertiesForHouseManagementGroupsModel());
                                    ...
                                    return Visibility(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed(
                                              HouseGroupCreateManagementWidget
                                                  .routeName,
                                              queryParameters: {
