...
import 'house_group_create_management_model.dart';
export 'house_group_create_management_model.dart';

class HouseGroupCreateManagementWidget extends StatefulWidget {
  const HouseGroupCreateManagementWidget({
    super.key,
  ...
  static String routeName = 'House_Group_Create_Management';
  static String routePath = '/houseGroupCreateManagement';

  @override
  State<HouseGroupCreateManagementWidget> createState() =>
      _HouseGroupCreateManagementWidgetState();
}

class _HouseGroupCreateManagementWidgetState
    extends State<HouseGroupCreateManagementWidget> {
  late HouseGroupCreateManagementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HouseGroupCreateManagementModel());
            ...
            child: Padding(
              ...
              child: StreamBuilder<PropertyRecord>(
                ...
                builder: (context, snapshot) {
                  ...
                  final scrollingColumnPropertyRecord = snapshot.data!;
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        StreamBuilder<PortfolioRecord>(
                          stream: PortfolioRecord.getDocument(
                              scrollingColumnPropertyRecord.portfolioId!),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                              return Center(
                            ...
                            final columnPortfolioRecord = snapshot.data!;
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        await broadcastsRecordReference
                                            .set(createBroadcastsRecordData(
                                          senderId: currentUserReference,
                                          broadcastName:
                                              _model.textController2.text,
                                          createdAt: getCurrentTimestamp,
                                          propertyId: widget.propertyID,
                                          groupType: 'Owner House',
                                        ));
