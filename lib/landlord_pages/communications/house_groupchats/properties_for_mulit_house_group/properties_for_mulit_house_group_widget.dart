...
import 'properties_for_mulit_house_group_model.dart';
export 'properties_for_mulit_house_group_model.dart';

class PropertiesForMulitHouseGroupWidget extends StatefulWidget {
  const PropertiesForMulitHouseGroupWidget({super.key});

  static String routeName = 'Properties_For_Mulit_House_Group';
  static String routePath = '/propertiesForMulitHouseGroup';

  @override
  State<PropertiesForMulitHouseGroupWidget> createState() =>
      _PropertiesForMulitHouseGroupWidgetState();
}

class _PropertiesForMulitHouseGroupWidgetState
    extends State<PropertiesForMulitHouseGroupWidget> {
  late PropertiesForMulitHouseGroupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PropertiesForMulitHouseGroupModel());
