...
import 'properties_for_house_group_model.dart';
export 'properties_for_house_group_model.dart';

class PropertiesForHouseGroupWidget extends StatefulWidget {
  const PropertiesForHouseGroupWidget({super.key});

  static String routeName = 'Properties_For_House_Group';
  static String routePath = '/propertiesForHouseGroup';

  @override
  State<PropertiesForHouseGroupWidget> createState() =>
      _PropertiesForHouseGroupWidgetState();
}

class _PropertiesForHouseGroupWidgetState
    extends State<PropertiesForHouseGroupWidget> {
  late PropertiesForHouseGroupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PropertiesForHouseGroupModel());
