...
import 'group_create_employees_model.dart';
export 'group_create_employees_model.dart';

class GroupCreateEmployeesWidget extends StatefulWidget {
  const GroupCreateEmployeesWidget({
    super.key,
  ...
  static String routeName = 'Group_Create_Employees';
  static String routePath = '/groupCreateEmployees';

  @override
  State<GroupCreateEmployeesWidget> createState() =>
      _GroupCreateEmployeesWidgetState();
}

class _GroupCreateEmployeesWidgetState
    extends State<GroupCreateEmployeesWidget> {
  late GroupCreateEmployeesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroupCreateEmployeesModel());
