...
import 'add_property_to_group_model.dart';
export 'add_property_to_group_model.dart';

class AddPropertyToGroupWidget extends StatefulWidget {
  const AddPropertyToGroupWidget({
    super.key,
  ...
  static String routeName = 'Add_Property_To_Group';
  static String routePath = '/addPropertyToGroup';

  @override
  State<AddPropertyToGroupWidget> createState() =>
      _AddPropertyToGroupWidgetState();
}

class _AddPropertyToGroupWidgetState extends State<AddPropertyToGroupWidget> {
  late AddPropertyToGroupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddPropertyToGroupModel());
            ...
            onPressed: () async {
              await showDialog(
                ...
                builder: (alertDialogContext) {
                  return WebViewAware(
                    child: AlertDialog(
                      title: Text('Adding Properties'),
                      content:
                          Text('This may take some time. Please be patient '),
                      actions: [
                        TextButton(
              ...
              while (_model.jIncre! < _model.reciepients.length) {
                await widget.broadcastID!.update({
                  ...mapToFirestore(
                    {
                      'recipients': FieldValue.arrayUnion(
                          [_model.reciepients.elementAtOrNull(_model.jIncre!)]),
                    },
                  ),
                });
                ...
                await widget.broadcastID!.update({
                  ...mapToFirestore(
                    {
                      'num_of_recipients': FieldValue.increment(1),
                    },
                  ),
                });
                _model.jIncre = _model.jIncre! + 1;
                safeSetState(() {});
              }
              _model.usersToNotify = await actions.filterUsersToNotify(
                functions
                    .getOtherUserRefs(
                        _model.reciepients.toList(), currentUserReference)!
                    .toList(),
              );
              triggerPushNotification(
                notificationTitle: 'Added to Group',
                notificationText: functions.nameConcat(
                    'You have been added to ', widget.broadcastName)!,
                notificationSound: 'default',
                userRefs: _model.usersToNotify!.toList(),
                ...
                builder: (alertDialogContext) {
                  return WebViewAware(
                    child: AlertDialog(
                      ...
                      content: Text(functions.nameConcat(
                          _model.selectNum.toString(), ' house(s) added.')!),
                      actions: [
                        TextButton(
                          onPressed: () => Navigator.pop(alertDialogContext),
                          child: Text('Ok'),
                            ...
                            child: StreamBuilder<List<PropertyRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount: listViewOPropertyRecordList.length,
                                  itemBuilder: (context, listViewOIndex) {
                                    ...
                                    return Visibility(
                                      visible:
                                          listViewOPropertyRecord.landlordId ==
                                    ...
                                    return Visibility(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed(
                                              HouseGroupCreateWidget.routeName,
                                              queryParameters: {
