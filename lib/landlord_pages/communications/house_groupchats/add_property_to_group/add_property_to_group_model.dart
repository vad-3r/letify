...
import '/index.dart';
import 'add_property_to_group_widget.dart' show AddPropertyToGroupWidget;
import 'package:flutter/material.dart';

class AddPropertyToGroupModel
    extends FlutterFlowModel<AddPropertyToGroupWidget> {
  ...
  // Stores action output result for [Custom Action - filterUsersToNotify] action in FloatingActionButton widget.
  List<DocumentReference>? usersToNotify;
