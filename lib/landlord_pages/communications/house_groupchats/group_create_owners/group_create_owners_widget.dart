...
import 'group_create_owners_model.dart';
export 'group_create_owners_model.dart';

class GroupCreateOwnersWidget extends StatefulWidget {
  const GroupCreateOwnersWidget({
    super.key,
  ...
  static String routeName = 'Group_Create_Owners';
  static String routePath = '/groupCreateOwners';

  @override
  State<GroupCreateOwnersWidget> createState() =>
      _GroupCreateOwnersWidgetState();
}

class _GroupCreateOwnersWidgetState extends State<GroupCreateOwnersWidget> {
  late GroupCreateOwnersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroupCreateOwnersModel());
