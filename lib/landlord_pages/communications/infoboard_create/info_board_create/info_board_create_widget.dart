...
import 'info_board_create_model.dart';
export 'info_board_create_model.dart';

class InfoBoardCreateWidget extends StatefulWidget {
  const InfoBoardCreateWidget({super.key});

  static String routeName = 'Info_Board_Create';
  static String routePath = '/infoBoardCreate';

  @override
  State<InfoBoardCreateWidget> createState() => _InfoBoardCreateWidgetState();
}

class _InfoBoardCreateWidgetState extends State<InfoBoardCreateWidget> {
  late InfoBoardCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InfoBoardCreateModel());
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        'Enter a title for your info board ',
                                    enabledBorder: OutlineInputBorder(
                                      borderSide: BorderSide(
                                        color: FlutterFlowTheme.of(context)
                                            .alternate,
                      ...
                      onPressed: () async {
                        ...
                        await infoBoardRecordReference.set({
                          ...
                          ...mapToFirestore(
                            {
                              'audience': () {
                                if (_model.dropDownValue == 'UFS Students') {
                        ...
                        triggerPushNotification(
                          ...
                          notificationText:
                              'An info board message has been made available to you !',
