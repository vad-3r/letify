...
import 'edit_broadcast_name_model.dart';
export 'edit_broadcast_name_model.dart';
...
class EditBroadcastNameWidget extends StatefulWidget {
  const EditBroadcastNameWidget({
    super.key,
  ...
  @override
  State<EditBroadcastNameWidget> createState() =>
      _EditBroadcastNameWidgetState();
}

class _EditBroadcastNameWidgetState extends State<EditBroadcastNameWidget> {
  late EditBroadcastNameModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditBroadcastNameModel());

    _model.emailAddressTextController ??=
        TextEditingController(text: widget.broadcastName);
