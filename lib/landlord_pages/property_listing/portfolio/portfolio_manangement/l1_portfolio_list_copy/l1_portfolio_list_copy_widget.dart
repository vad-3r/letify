...
import 'l1_portfolio_list_copy_model.dart';
export 'l1_portfolio_list_copy_model.dart';

class L1PortfolioListCopyWidget extends StatefulWidget {
  const L1PortfolioListCopyWidget({super.key});

  static String routeName = 'L1_Portfolio_listCopy';
  static String routePath = '/l1PortfolioListCopy';

  @override
  State<L1PortfolioListCopyWidget> createState() =>
      _L1PortfolioListCopyWidgetState();
}

class _L1PortfolioListCopyWidgetState extends State<L1PortfolioListCopyWidget> {
  late L1PortfolioListCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => L1PortfolioListCopyModel());
