...
import '/landlord_pages/property_listing/portfolio/portfolio_manangement/room_added/room_added_widget.dart';
...
import 'l7_add_room_model.dart';
export 'l7_add_room_model.dart';

class L7AddRoomWidget extends StatefulWidget {
  const L7AddRoomWidget({
    super.key,
  ...
  static String routeName = 'L7_add_Room';
  static String routePath = '/l7AddRoom';

  @override
  State<L7AddRoomWidget> createState() => _L7AddRoomWidgetState();
}

class _L7AddRoomWidgetState extends State<L7AddRoomWidget> {
  late L7AddRoomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => L7AddRoomModel());
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 0.0),
                        child: Text(
                          'How many rooms of this type in your property?',
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context)
                              .labelMedium
                              .override(
                      ...
                      onPressed: () async {
                        while (FFAppState().i <
                          ...
                          await roomRecordReference.set(createRoomRecordData(
                            roomDescription: _model.textController1.text,
                            ...
                            roomIndex:
                                functions.indexIndentForName(FFAppState().i),
                          ));
                          _model.createdRoom = RoomRecord.getDocumentFromData(
                          ...
                          await widget.propertyID!.update({
                            ...mapToFirestore(
                              {
                                'roomsInProperty': FieldValue.arrayUnion(
