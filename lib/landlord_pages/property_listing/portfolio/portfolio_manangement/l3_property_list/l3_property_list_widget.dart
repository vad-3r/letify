...
import '/landlord_pages/property_listing/portfolio/portfolio_manangement/delete_property/delete_property_widget.dart';
import '/landlord_pages/property_listing/portfolio/portfolio_manangement/duplicate_house/duplicate_house_widget.dart';
...
import 'l3_property_list_model.dart';
export 'l3_property_list_model.dart';

class L3PropertyListWidget extends StatefulWidget {
  const L3PropertyListWidget({
    super.key,
  ...
  static String routeName = 'L3_Property_list';
  static String routePath = '/l3PropertyList';

  @override
  State<L3PropertyListWidget> createState() => _L3PropertyListWidgetState();
}

class _L3PropertyListWidgetState extends State<L3PropertyListWidget> {
  late L3PropertyListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => L3PropertyListModel());
