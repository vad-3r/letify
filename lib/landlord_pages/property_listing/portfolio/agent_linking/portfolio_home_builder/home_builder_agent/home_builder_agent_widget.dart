...
import 'home_builder_agent_model.dart';
export 'home_builder_agent_model.dart';

class HomeBuilderAgentWidget extends StatefulWidget {
  const HomeBuilderAgentWidget({
    super.key,
  ...
  static String routeName = 'Home_Builder_Agent';
  static String routePath = '/homeBuilderAgent';

  @override
  State<HomeBuilderAgentWidget> createState() => _HomeBuilderAgentWidgetState();
}

class _HomeBuilderAgentWidgetState extends State<HomeBuilderAgentWidget>
    with TickerProviderStateMixin {
  late HomeBuilderAgentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeBuilderAgentModel());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(
                PropertyListAgentsWidget.routeName,
                queryParameters: {
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            tenantsLinked:
                                                                                containerContractRecord!.tenantsLinked,
                                                                            contractID:
                                                                                containerContractRecord.reference,
                                                                          ),
                                                                        ),
                                                                      ),
                                                                    );
                                                              ...
                                                              return Column(
                                                                mainAxisSize:
                                                                    MainAxisSize
                                                                        .max,
                                                                children: [
                                                                  if ((listViewRoomRecord.roomStatus == 'Occupied') &&
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        if ((currentUserDocument?.permissions.toList() ?? []).contains(functions.aString('Override Contracts')) ==
                                                                            true) {
                                                                          await showModalBottomSheet(
                                                                            isScrollControlled:
                                                                                true,
                                                                  ...
                                                                  if ((listViewRoomRecord.roomStatus == 'Occupied') &&
                                                                      ...
                                                                      (columnTenantInfoRecord
                                                                              ?.isSigned ==
                                                                          true) &&
                                                                      ((columnTenantInfoRecord?.copyOfId == null ||
                                                                              columnTenantInfoRecord?.copyOfId ==
                                                                                  '') &&
                                                                          (columnTenantInfoRecord?.copyOfStudentCard == null ||
                                                                              columnTenantInfoRecord?.copyOfStudentCard == '')))
                                                                    InkWell(
                                                                      splashColor:
                                                                          Colors
                                                                              .transparent,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          await actions
                                                                            ...
                                                                            columnContractRecord!.lessorName,
                                                                            columnContractRecord.idNum,
                                                                            columnContractRecord.streetAddress,
                                                                            columnContractRecord.suburb,
                                                                            columnContractRecord.city,
                                                                            columnContractRecord.postalCode,
                                                                            columnContractRecord.eMail,
                                                                            columnContractRecord.telPhone,
                                                                            columnTenantInfoRecord!.lesseeName,
                                                                            columnTenantInfoRecord.lesseeIdNum,
                                                                            columnTenantInfoRecord.lesseeStreetAddress,
                                                                            columnTenantInfoRecord.lesseeProvince,
                                                                            columnTenantInfoRecord.lesseeCity,
                                                                            columnTenantInfoRecord.lesseePostalCode,
                                                                            columnTenantInfoRecord.lesseeEmail,
                                                                            columnTenantInfoRecord.lesseeTelphone,
                                                                            listViewRoomRecord.roomName,
                                                                            functions.nameConcat(columnTenantInfoRecord.prtpName,
                                                                                columnTenantInfoRecord.prtpSurname)!,
                                                                            columnTenantInfoRecord.prtpIdNum,
                                                                            columnTenantInfoRecord.prtpStreetAddress,
                                                                            columnTenantInfoRecord.prtpProvince,
                                                                            columnTenantInfoRecord.prtpCity,
                                                                            columnTenantInfoRecord.prtpPostalCode,
                                                                            columnTenantInfoRecord.prtpEmail,
                                                                            columnTenantInfoRecord.prtpTel,
                                                                            functions.nameConcat(columnTenantInfoRecord.nokName,
                                                                                columnTenantInfoRecord.nokSurnam)!,
                                                                            columnTenantInfoRecord.nokIdNum,
                                                                            columnTenantInfoRecord.nokStreetAddress,
                                                                            columnTenantInfoRecord.nokProvince,
                                                                            columnTenantInfoRecord.nokCity,
                                                                            columnTenantInfoRecord.nokPostalCode,
                                                                            columnTenantInfoRecord.nokEmail,
                                                                            columnTenantInfoRecord.nokTel,
                                                                            widget.propertyName!,
                                                                            listViewRoomRecord.tenantStudentNum,
                                                                            columnContractRecord.topTen1,
                                                                            columnContractRecord.topTen2,
                                                                            columnContractRecord.topTen3,
                                                                            columnContractRecord.topTen4,
                                                                            columnContractRecord.topTen5,
                                                                            columnContractRecord.topTen6,
                                                                            columnContractRecord.topTen7,
                                                                            columnContractRecord.topTen8,
                                                                            columnContractRecord.topTen9,
                                                                            columnContractRecord.topTen10,
                                                                            columnContractRecord.contractId,
                                                                            columnContractRecord.startDate!,
                                                                            columnContractRecord.endDate!,
                                                                            columnContractRecord.montlyRent,
                                                                            columnContractRecord.electricityRules,
                                                                            columnContractRecord.waterRules,
                                                                            columnContractRecord.geyserRules,
                                                                            columnContractRecord.roomType,
                                                                            columnContractRecord.adminFee,
                                                                            columnContractRecord.refundableFee,
                                                                            columnContractRecord.deposit,
                                                                            columnContractRecord.keyDeposit,
                                                                            columnContractRecord.customRoomType,
                                                                            columnTenantInfoRecord.tenantSignature,
                                                                            FFAppConstants.logoLetify,
                                                                            columnContractRecord.houseRules,
                                                                            functions.convertToString(columnTenantInfoRecord.copyOfId),
                                                                            functions.convertToString(columnTenantInfoRecord.copyOfStudentCard),
                                                                            FFAppConstants.llwelynStamp,
                                                                            columnContractRecord.signatureimagepath,
                                                                            columnContractRecord.signature1Url,
                                                                            columnContractRecord.signature2Url,
                                                                            columnContractRecord.signatureimagepath,
                                                                          );
                                                                        },
                                                                        onLongPress:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            if ((listViewRoomRecord.roomStatus == 'Occupied') &&
                                                                                (listViewRoomRecord.isSigned == true))
                                                                              Text(
                                                                                'Signed',
                                                                    ...
                                                                    children: [
                                                                      if (listViewRoomRecord
                                                                        ...
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            functions.nameConcat(listViewRoomRecord.tenantName,
                                                                                listViewRoomRecord.tenantSurname),
                                                                            'Tenant Name',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
