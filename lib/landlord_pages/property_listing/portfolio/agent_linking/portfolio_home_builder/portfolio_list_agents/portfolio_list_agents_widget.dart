...
import 'portfolio_list_agents_model.dart';
export 'portfolio_list_agents_model.dart';

class PortfolioListAgentsWidget extends StatefulWidget {
  const PortfolioListAgentsWidget({super.key});

  static String routeName = 'Portfolio_list_Agents';
  static String routePath = '/portfolioListAgents';

  @override
  State<PortfolioListAgentsWidget> createState() =>
      _PortfolioListAgentsWidgetState();
}

class _PortfolioListAgentsWidgetState extends State<PortfolioListAgentsWidget> {
  late PortfolioListAgentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PortfolioListAgentsModel());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  if ((currentUserDocument?.employer.toList() ?? []).length !=
                      0)
                    Padding(
                      padding:
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) =>
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<PortfolioRecord> listViewPortfolioRecordList =
                                snapshot.data!;
                            ...
                            return ListView.builder(
                              ...
                              itemCount: listViewPortfolioRecordList.length,
                              itemBuilder: (context, listViewIndex) {
                                final listViewPortfolioRecord =
                                    listViewPortfolioRecordList[listViewIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 2.0),
                                  child: InkWell(
                                      ...
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          ...
                                          'portfolioID': serializeParam(
                                            listViewPortfolioRecord.reference,
