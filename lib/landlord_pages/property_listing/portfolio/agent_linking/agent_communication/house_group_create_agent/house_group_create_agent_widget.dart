...
import 'house_group_create_agent_model.dart';
export 'house_group_create_agent_model.dart';

class HouseGroupCreateAgentWidget extends StatefulWidget {
  const HouseGroupCreateAgentWidget({
    super.key,
  ...
  static String routeName = 'House_Group_Create_Agent';
  static String routePath = '/houseGroupCreateAgent';

  @override
  State<HouseGroupCreateAgentWidget> createState() =>
      _HouseGroupCreateAgentWidgetState();
}

class _HouseGroupCreateAgentWidgetState
    extends State<HouseGroupCreateAgentWidget> {
  late HouseGroupCreateAgentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HouseGroupCreateAgentModel());
