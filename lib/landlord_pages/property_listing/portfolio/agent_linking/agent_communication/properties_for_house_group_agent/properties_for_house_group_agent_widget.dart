...
import 'properties_for_house_group_agent_model.dart';
export 'properties_for_house_group_agent_model.dart';

class PropertiesForHouseGroupAgentWidget extends StatefulWidget {
  const PropertiesForHouseGroupAgentWidget({super.key});

  static String routeName = 'Properties_For_House_Group_Agent';
  static String routePath = '/propertiesForHouseGroupAgent';

  @override
  State<PropertiesForHouseGroupAgentWidget> createState() =>
      _PropertiesForHouseGroupAgentWidgetState();
}

class _PropertiesForHouseGroupAgentWidgetState
    extends State<PropertiesForHouseGroupAgentWidget> {
  late PropertiesForHouseGroupAgentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PropertiesForHouseGroupAgentModel());
