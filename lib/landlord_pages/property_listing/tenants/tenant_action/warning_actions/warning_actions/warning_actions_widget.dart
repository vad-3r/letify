...
import 'warning_actions_model.dart';
export 'warning_actions_model.dart';

class WarningActionsWidget extends StatefulWidget {
  const WarningActionsWidget({
    super.key,
  ...
  @override
  State<WarningActionsWidget> createState() => _WarningActionsWidgetState();
}

class _WarningActionsWidgetState extends State<WarningActionsWidget>
    with TickerProviderStateMixin {
  late WarningActionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WarningActionsModel());
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          await columnStudentRecord!.reference
                                              .update({
                                            ...mapToFirestore(
                                              {
                                                'warning':
