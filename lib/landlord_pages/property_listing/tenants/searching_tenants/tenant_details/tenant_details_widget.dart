...
class TenantDetailsWidget extends StatefulWidget {
  ...
  static String routeName = 'Tenant_Details';
  static String routePath = '/tenantDetails';
                  ...
                  child: Padding(
                    ...
                    child: StreamBuilder<List<StudentRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<StudentRecord> scrollingColumnStudentRecordList =
                            snapshot.data!;
                        // Return an empty Container when the item does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final scrollingColumnStudentRecord =
                            scrollingColumnStudentRecordList.isNotEmpty
                                ? scrollingColumnStudentRecordList.first
                                : null;
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  if (scrollingColumnStudentRecord
                                          ?.linkedToProperty ==
                                      true)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
