...
import 'link_contract_model.dart';
export 'link_contract_model.dart';

class LinkContractWidget extends StatefulWidget {
  const LinkContractWidget({
    super.key,
  ...
  final DocumentReference? tenantID;
  final String? propertyStringID;

  static String routeName = 'Link_Contract';
  static String routePath = '/linkContract';

  @override
  State<LinkContractWidget> createState() => _LinkContractWidgetState();
}

class _LinkContractWidgetState extends State<LinkContractWidget> {
  late LinkContractModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LinkContractModel());
                      ...
                      children: [
                        RichText(
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text: 'Select contract to link to student',
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    triggerPushNotification(
                                                      notificationTitle:
                                                          'Contract Available',
                                                      notificationText:
                                                          'A contract has been made available for you',
