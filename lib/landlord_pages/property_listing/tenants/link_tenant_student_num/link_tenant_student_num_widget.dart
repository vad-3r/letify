...
import 'link_tenant_student_num_model.dart';
export 'link_tenant_student_num_model.dart';

class LinkTenantStudentNumWidget extends StatefulWidget {
  const LinkTenantStudentNumWidget({
    super.key,
  ...
  static String routeName = 'Link_Tenant_Student_Num';
  static String routePath = '/linkTenantStudentNum';

  @override
  State<LinkTenantStudentNumWidget> createState() =>
      _LinkTenantStudentNumWidgetState();
}

class _LinkTenantStudentNumWidgetState
    extends State<LinkTenantStudentNumWidget> {
  late LinkTenantStudentNumModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LinkTenantStudentNumModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.lstStudentss = await queryStudentRecordOnce(
      ...
      _model.lstStudents = _model.lstStudentss!.toList().cast<StudentRecord>();
      safeSetState(() {});
    });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (_model.lstStudents
                        .where((e) => e.hasStudentNumber())
                        .toList()
                        .unique((e) => widget.iDNumber!)
                        .length ==
                    0)
                  Row(
                    mainAxisSize: MainAxisSize.max,
                      ...
                      RichText(
                        ...
                        text: TextSpan(
                          children: [
                            TextSpan(
                              text:
                                  'No student found matching student number: ',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
