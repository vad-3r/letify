...
import 'tenant_contracts_i_d_model.dart';
export 'tenant_contracts_i_d_model.dart';

class TenantContractsIDWidget extends StatefulWidget {
  const TenantContractsIDWidget({
    super.key,
    this.tenantIDNumber,
  });
  ...
  static String routeName = 'Tenant_Contracts_ID';
  static String routePath = '/tenantContractsID';

  @override
  State<TenantContractsIDWidget> createState() =>
      _TenantContractsIDWidgetState();
}

class _TenantContractsIDWidgetState extends State<TenantContractsIDWidget> {
  late TenantContractsIDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TenantContractsIDModel());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(SearchForTenantContractsWidget.routeName);
            },
          ),
          title: Text(
            'Tenant Contracts',
