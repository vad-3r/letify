...
import 'denial_reason_model.dart';
export 'denial_reason_model.dart';

class DenialReasonWidget extends StatefulWidget {
  const DenialReasonWidget({
    super.key,
  ...
  final DocumentReference? tenantRef;

  @override
  State<DenialReasonWidget> createState() => _DenialReasonWidgetState();
}

class _DenialReasonWidgetState extends State<DenialReasonWidget> {
  late DenialReasonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DenialReasonModel());
              ...
              Padding(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: 'Reason for denying contract',
                      ...
                      onPressed: () async {
                        if (_model.rentTextController.text == '') {
                          ...
                          await widget.tenantInfo!
                            ...
                            isApproved: false,
                            isReviewed: true,
                            denialReason: _model.rentTextController.text,
                          ));
                          Navigator.pop(context);
                        }
                      },
