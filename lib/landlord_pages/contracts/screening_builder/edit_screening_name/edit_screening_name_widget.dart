...
import 'edit_screening_name_model.dart';
export 'edit_screening_name_model.dart';

class EditScreeningNameWidget extends StatefulWidget {
  const EditScreeningNameWidget({
    super.key,
  ...
  @override
  State<EditScreeningNameWidget> createState() =>
      _EditScreeningNameWidgetState();
}

class _EditScreeningNameWidgetState extends State<EditScreeningNameWidget> {
  late EditScreeningNameModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditScreeningNameModel());
