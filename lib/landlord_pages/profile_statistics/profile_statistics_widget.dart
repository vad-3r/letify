...
class ProfileStatisticsWidget extends StatefulWidget {
  const ProfileStatisticsWidget({super.key});

  static String routeName = 'Profile_Statistics';
  static String routePath = '/profileStatistics';

  @override
  State<ProfileStatisticsWidget> createState() =>
      _ProfileStatisticsWidgetState();
}

class _ProfileStatisticsWidgetState extends State<ProfileStatisticsWidget>
    with TickerProviderStateMixin {
  late ProfileStatisticsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileStatisticsModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (valueOrDefault(currentUserDocument?.userRole, '') == 'Student') {
        ...
        _model.portfolio = await queryPortfolioRecordOnce(
          queryBuilder: (portfolioRecord) => portfolioRecord.where(
            'landlord_id',
            isEqualTo: currentUserReference,
          ),
        );
        _model.linkedPorts = await queryPortfolioRecordOnce(
          queryBuilder: (portfolioRecord) => portfolioRecord.where(
            'owners_list2',
            arrayContains: currentUserReference,
          ),
        );
        _model.linkedProperties = await actions.getLinkedProperties(
          _model.linkedPorts!.map((e) => e.reference).toList().toList(),
        );
        ...
        _model.occupiedRooms = await actions.getOccupiedRooms(
          _model.properties!.map((e) => e.reference).toList().toList(),
        );
        _model.bachelorRooms = await actions.getBachelorRooms(
          _model.properties!.map((e) => e.reference).toList().toList(),
        );
        _model.flatRooms = await actions.getFlatRooms(
          _model.properties!.map((e) => e.reference).toList().toList(),
        );
        ...
        _model.sentContracts = await actions.getTotalTenantCount(
          currentUserReference!,
        );
        _model.contractsSent = await actions.getContractsGenerated(
          _model.properties!.map((e) => e.reference).toList().toList(),
        );
        _model.signedContracts = await actions.getTenantsSigned(
          _model.properties!.map((e) => e.reference).toList().toList(),
        );
        ...
        _model.vacantRooms = await actions.getVacantRooms(
          _model.properties!.map((e) => e.reference).toList().toList(),
        );
            ...
            title: Row(
              ...
              children: [
                ...
                if (responsiveVisibility(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await actions.sendVacantRoomReport(
                        _model.properties!.map((e) => e.reference).toList(),
                        'lebohang.letebele69@gmail.com',
                      );
                    },
                    text: 'Report',
                                                              ...
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    functions
                                                                        .addition(
                                                                            _model.portfolio?.length,
                                                                            _model.linkedPorts?.length)
                                                                        .toString(),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .displaySmall
                                                              ...
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    functions
                                                                        .addition(
                                                                            _model.linkedProperties,
                                                                            _model.properties?.length)
                                                                        .toString(),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .displaySmall
                                  ...
                                  Padding(
                                    ...
                                    child: LinearPercentIndicator(
                                      percent: functions.decimalOccupied(
                                          _model.allRooms, _model.vacantRooms)!,
