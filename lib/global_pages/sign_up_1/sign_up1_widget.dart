...
class SignUp1Widget extends StatefulWidget {
  ...
  static String routeName = 'SignUp_1';
...
class _SignUp1WidgetState extends State<SignUp1Widget> {
  ...
  void initState() {
    ...
    _model.userSurnameTextController ??= TextEditingController();
    _model.userSurnameFocusNode ??= FocusNode();
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .userSurnameTextController,
                                            focusNode:
                                                _model.userSurnameFocusNode,
                                            autofocus: true,
                                            autofillHints: [
                                            ...
                                            keyboardType: TextInputType.name,
                                            validator: _model
                                                .userSurnameTextControllerValidator
                                                .asValidator(context),
                                            inputFormatters: [
                                              if (!isAndroid && !isiOS)
                                                TextInputFormatter.withFunction(
